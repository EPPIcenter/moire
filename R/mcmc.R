...
#' @param num_chains Positive Integer. Number of concurrent chains to run (not implemented)
#' @param importance_sampling_depth Positive Integer. How many samples to take during importance sampling

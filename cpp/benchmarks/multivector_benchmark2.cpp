...
int main(int argc, char* argv[]) {
    ...
    moire_bench::BenchmarkSuite suite("MultiVector simple benchmarks");
    suite.add("Construction", [&]{ benchmark_construction(dimensions); });
    suite.add("Element assignment", [&]{ benchmark_element_assignment(dimensions); });
    suite.add("Read for-loop iteration", [&]{ benchmark_read_for_loop_iteration(dimensions); });
    suite.add("Read for-loop swapped iteration", [&]{ benchmark_read_for_loop_swapped_iteration(dimensions); });
    suite.add("Read for-loop inverted iteration", [&]{ benchmark_read_for_loop_inverted_iteration(dimensions); });
    suite.add("Iterator iteration", [&]{ benchmark_iterator_iteration(dimensions); });
    suite.add("Naive construction", [&]{ naive_benchmark_construction(dimensions); });
    suite.add("Naive element assignment", [&]{ naive_benchmark_element_assignment(dimensions); });
    suite.add("Naive read for-loop iteration", [&]{ naive_benchmark_read_for_loop_iteration(dimensions); });
    suite.add("Naive read for-loop swapped", [&]{ naive_benchmark_read_for_loop_swapped_iteration(dimensions); });
    suite.add("Naive read for-loop inverted", [&]{ naive_benchmark_read_for_loop_inverted_iteration(dimensions); });
    suite.add("Naive iterator iteration", [&]{ naive_benchmark_iterator_iteration(dimensions); });
    suite.run_all();
    return 0;
} 
...
int main() {
    moire_bench::BenchmarkSuite suite("MultiVector comprehensive benchmarks");
    ...
    suite.add("1D MultiVector", benchmark_1d_multivector);
    suite.add("2D MultiVector", benchmark_2d_multivector);
    suite.add("Reduce Functions", benchmark_reduce_functions);
    suite.add("4D MultiVector", benchmark_4d_multivector);
    suite.add("Different Sizes", benchmark_different_sizes);
    suite.add("Different Operations", benchmark_different_operations);
    suite.add("LogSumExp", benchmark_logsumexp);
    suite.add("Element Transform", benchmark_element_transform);
    suite.add("Elementwise Operations", benchmark_elementwise_operations);
    suite.add("Chained Reductions", benchmark_chained_reductions);
